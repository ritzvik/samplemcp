"""Function to update an experiment run in a Cloudera ML project."""
...
def update_experiment_run(config, params=None):
    """
    Update an experiment run in a Cloudera ML project.
    ...
    if not run_id:
        return {"success": False, "message": "run_id is required in params", "data": None}
    ...
    try:
        ...
        try:
            ...
            return {"success": True, "message": f"Successfully updated experiment run {run_id}", "data": data}
