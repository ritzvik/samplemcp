"""Function to stop a running application in a Cloudera ML project."""
...
def stop_application(config, params=None):
    """
    ...
    Args:
        ...
        params (dict, optional): Parameters for the API call. Default is None.
            ...
            - application_id (str): ID of the application to stop.
    ...
    # Build the API URL
    url = f"{host}/api/v2/projects/{project_id}/applications/{application_id}/stop"
    ...
    try:
        ...
        try:
            ...
            return {"success": True, "message": f"Successfully stopped application {application_id}", "data": data}
